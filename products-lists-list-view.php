	...
	<div class="row">
		<div class="col-md-3-24"> <strong>Your are here:</strong> </div> <!-- col.// -->
		  ...
		  <div class="col-md-3-24 text-right"> 
		  	<a data-toggle="tooltip" title="List view"> <i class="fa fa-bars"></i></a>
		  	<a href="products-lists-grid-view.php" data-toggle="tooltip" title="Grid view"> <i class="fa fa-th"></i></a>
		  </div> <!-- col.// -->
	</div>
</div>
<div class="row">
