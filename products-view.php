...
<div class="img-big-wrap">
  <div> <a href="img/items/1.jpg" data-fancybox=""><img src="img/items/1.jpg"></a></div>
</div> <!-- slider-product.// -->
<div class="img-small-wrap">
  <div class="item-gallery"> <img src="img/items/1.jpg"></div>
  <div class="item-gallery"> <img src="img/items/2.jpg"></div>
  <div class="item-gallery"> <img src="img/items/3.jpg"></div>
  <div class="item-gallery"> <img src="img/items/4.jpg"></div>
</div> <!-- slider-nav.// -->
...
<div class="col-md-12 col-sm-3">
	<figure class="item border-bottom mb-3">
			<a href="products-view.php" class="img-wrap"> <img src="img/items/2.jpg" class="img-md"></a>
...
<div class="col-md-12 col-sm-3">
<figure class="item border-bottom mb-3">
		<a href="products-view.php" class="img-wrap"> <img src="img/items/3.jpg" class="img-md"></a>
		<figcaption class="info-wrap">
			<a href="products-view.php" class="title">The name of product</a>
			<div class="price-wrap mb-3">
				<span class="price-new">$280</span> <del class="price-old">$280</del>
...
<div class="col-md-12 col-sm-3">
<figure class="item border-bottom mb-3">
		<a href="products-view.php" class="img-wrap"> <img src="img/items/4.jpg" class="img-md"></a>
		<figcaption class="info-wrap">
			<a href="products-view.php" class="title">The name of product</a> 
			<div class="price-wrap mb-3">
				<span class="price-new">$280</span> <del class="price-old">$280</del>
