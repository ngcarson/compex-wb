						...
						<aside class="col-sm-6 border-right">
							<article class="gallery-wrap"> 
								<div class="img-big-wrap">
						  		<div> <a href="img/items/1.jpg" data-fancybox=""><img src="img/items/1.jpg" alt=""></a></div>
								</div> <!-- slider-product.// -->
								<div class="img-small-wrap">
						  		<div class="item-gallery"> <img src="img/items/1.jpg" alt=""></div>
						  		<div class="item-gallery"> <img src="img/items/2.jpg" alt=""></div>
						  		<div class="item-gallery"> <img src="img/items/3.jpg" alt=""></div>
						  		<div class="item-gallery"> <img src="img/items/4.jpg" alt=""></div>
								</div> <!-- slider-nav.// -->
					...
					<div class="card-body row">
						<div class="col-md-12 col-sm-3">
							<figure class="item border-bottom mb-3">
									<a href="products-view.php" class="img-wrap"> <img src="img/items/2.jpg" class="img-md" alt=""></a>
									<figcaption class="info-wrap">
										<a href="products-view.php" class="title">The name of product</a>
						...
						<div class="col-md-12 col-sm-3">
							<figure class="item border-bottom mb-3">
									<a href="products-view.php" class="img-wrap"> <img src="img/items/3.jpg" class="img-md" alt=""></a>
									<figcaption class="info-wrap">
										<a href="products-view.php" class="title">The name of product</a>
										<div class="price-wrap mb-3">
											<span class="price-new">$280</span> <del class="price-old">$280</del>
						...
						<div class="col-md-12 col-sm-3">
							<figure class="item border-bottom mb-3">
								<a href="products-view.php" class="img-wrap"> <img src="img/items/4.jpg" class="img-md" alt=""></a>
								<figcaption class="info-wrap">
									<a href="products-view.php" class="title">The name of product</a> 
									<div class="price-wrap mb-3">
										<span class="price-new">$280</span> <del class="price-old">$280</del>
